...
import { ShieldCheck, Cpu, Globe2, Sparkles, Target, Lightbulb, Users, Award, TrendingUp, MapPin, Clock, CheckCircle } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Hakkımızda | Emkan.site',
  description: 'Deniz taşımacılığı ve emtia ticaretinde güvenilir ortağınız. Misyonumuz ve vizyonumuz hakkında bilgi edinin.',
}
...
export default function AboutPage() {
  return (
    <>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <Reveal y={30} className="space-y-8">
                ...
                <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                  <p>
                    Firmamızın başlıca hedefi, müşteri odaklı ve verimliliği merkez alan bir yönetim yaklaşımı oluşturmaktır. Bu yaklaşım, sadece maddi kazanımlarla değil, bütün toplumun yararlandığı ve yararlanacağı kurumsal yurttaşlık bilinciyle iç içe gelişmektedir.
                  </p>
                  <p>
                    Küresel deniz taşımacılığı ve emtia ticaretinde güvenilir bir köprü olmayı hedefliyoruz. Operasyonel mükemmellik, etik ilkelere bağlılık ve sürdürülebilir büyüme ile değer yaratıyoruz.
                  </p>
                </div>
              </Reveal>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <Reveal y={30} className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6">Yolculuğumuz</h2>
              <p className="text-xl text-gray-600">
                Büyüme ve gelişim sürecimizdeki önemli kilometre taşları
              </p>
            </Reveal>
            ...
            <div className="relative">
              ...
              <div className="space-y-12">
                {[
                  { year: '2020', title: 'Kuruluş', description: 'Şirket kuruluşu ve ilk deniz taşımacılığı operasyonları', icon: Target },
                  { year: '2021', title: 'Genişleme', description: 'Üre ticaretine başlangıç ve ilk büyük kontratlar', icon: TrendingUp },
                  { year: '2022', title: 'Dijitalleşme', description: 'Bitum ticareti genişletme ve dijital takip sistemi', icon: Cpu },
                  { year: '2023', title: 'Küreselleşme', description: '45+ ülkeye hizmet ve sürdürülebilirlik programları', icon: Globe2 },
                ].map((item, index) => (
                  <Reveal key={index} y={30} delay={index * 0.1} className="relative flex items-start gap-8">
                    <div className="w-16 h-16 bg-gradient-to-br from-accent to-primary rounded-2xl flex items-center justify-center relative z-10">
      ...
      {/* Geographic Reach - Redesigned */}
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            <Reveal y={30} className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6">Coğrafi Yayılım</h2>
              <p className="text-xl text-gray-600">
                Dünya çapında güvenilir hizmet ağımız
              </p>
            </Reveal>

            <div className="grid md:grid-cols-3 gap-8">
              <Reveal y={30} delay={0.1} className="text-center group">
                <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-accent/30">
                  ...
                  <h3 className="text-2xl font-bold text-primary mb-2">Avrupa</h3>
                  <div className="text-4xl font-bold text-accent mb-2">15</div>
                  <p className="text-gray-600">Ülke</p>
                </div>
              </Reveal>

              <Reveal y={30} delay={0.2} className="text-center group">
                <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-accent/30">
                  <div className="w-20 h-20 bg-gradient-to-br from-accent/20 to-accent/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <Globe2 className="w-10 h-10 text-accent" />
                  </div>
                  <h3 className="text-2xl font-bold text-primary mb-2">Asya</h3>
                  <div className="text-4xl font-bold text-accent mb-2">18</div>
                  <p className="text-gray-600">Ülke</p>
                </div>
              </Reveal>

              <Reveal y={30} delay={0.3} className="text-center group">
                <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-accent/30">
                  <div className="w-20 h-20 bg-gradient-to-br from-accent/20 to-accent/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <Users className="w-10 h-10 text-accent" />
                  </div>
                  <h3 className="text-2xl font-bold text-primary mb-2">Afrika & Amerika</h3>
